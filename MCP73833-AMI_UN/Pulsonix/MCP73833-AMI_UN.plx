...
(library Library_1
	...
	(compDef "MCP73833-AMI_UN" (originalName "MCP73833-AMI_UN") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "STAT2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VSS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "VBAT_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "VBAT_1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "THERM") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "__PG(__TE)") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "PROG") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://componentsearchengine.com/Datasheets/1/MCP73833-AMI_UN.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MCP73833-AMI_UN.stp")
